...
Vor Arbeitsbeginn: Lies `context.md` vollstaendig.
Nach jeder Aktion: Protokoll in `context.md` aktualisieren.
Bei Blockern: In `context.md` Notizen mit `@Agent-Name` dokumentieren.
