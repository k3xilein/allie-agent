...
export const config = {
  ...
  trading: {
    ...
    analysisIntervalMinutes: parseInt(process.env.ANALYSIS_INTERVAL || '2', 10),
    maxPositionSizePercent: parseFloat(process.env.MAX_POSITION_SIZE_PCT || '20'),
    maxDailyLossPercent: parseFloat(process.env.MAX_DAILY_LOSS_PCT || '8'),
    maxDrawdownPercent: parseFloat(process.env.MAX_DRAWDOWN_PCT || '25'),
    ...
    minRiskRewardRatio: parseFloat(process.env.MIN_RISK_REWARD || '1.2'),
    ...
    stopLossPercent: parseFloat(process.env.DEFAULT_STOP_LOSS_PCT || '3'),
    takeProfitPercent: parseFloat(process.env.DEFAULT_TAKE_PROFIT_PCT || '6'),
  },
};
